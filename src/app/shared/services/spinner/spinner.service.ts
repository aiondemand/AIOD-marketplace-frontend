...
export class SpinnerService {
  ...
  public visibility$: Observable<boolean> = this.spinnerVisibilitySubject.asObservable();
  public message$: Observable<string> = this.spinnerMessageSubject.asObservable();
